<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.transaksis.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $transaksi)
                                        <a
                                            href="{{ route('transaksis.show', $transaksi) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $transaksi)
                                        <form
                                            action="{{ route('transaksis.destroy', $transaksi) }}"
                                            method="POST"
