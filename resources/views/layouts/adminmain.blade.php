...
<head>
    ...
    <title>Dashboard &mdash; SIPAK RT</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/assets/css/components.css') }}">
</head>
...
<body>
    ...
    <script src="{{ asset('assets_admin/assets/js/page/index-0.js') }}"></script>
</body>
